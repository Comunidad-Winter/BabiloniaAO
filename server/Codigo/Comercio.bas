...
'*************************************************
    ...
    If Modo = eModoComercio.Compra Then
        ...
        If TieneObjetos(710, ValorCopas, UserIndex) = False Then
         Call WriteConsoleMsg(UserIndex, "No tienes copas suficientes", FontTypeNames.FONTTYPE_GM)
         Exit Sub
        End If
        ...
        If ValorCopas > 0 Then Call QuitarObjetos(710, ValorCopas, UserIndex): Call UpdateUserInv(True, UserIndex, 0)
