...
Public Const RYKAN As Integer = 1143 'reemplazar por el numero de objeto del collar de rykan en tu obj.dat
...
Public Const aumentoSTArquero As Byte = AumentoSTDef + 25
...
Public Const NOMANA As Byte = 237
Public Const INVENTARIOLLENO As Byte = 238
