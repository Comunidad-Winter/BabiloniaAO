...
On Error GoTo Errhandler
    ...
    If CountdownTime > 1 Then
        ...
        If CountdownMap > 0 Then
            Call SendData(SendTarget.toMap, CountdownMap, PrepareMessageConsoleMsg(CountdownTime, FontTypeNames.FONTTYPE_GUILD))
        Else
            Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg(CountdownTime, FontTypeNames.FONTTYPE_GUILD))
        End If
