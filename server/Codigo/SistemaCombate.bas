...
'***************************************************
    ...
    With Npclist(NpcIndex)
        ...
        If daño < 150 Then
            Call WriteChatOverHead(UserIndex, daño, UserList(UserIndex).Char.CharIndex, vbRed)
        Else
            Call WriteChatOverHead(UserIndex, "¡" & daño & "!", UserList(UserIndex).Char.CharIndex, vbYellow)
        End If
...
'*************************************************
    ...
    Else
        ...
        Call WriteChatOverHead(UserIndex, "¡Falla!", Npclist(NpcIndex).Char.CharIndex, vbRed)
...
On Error GoTo Errhandler
    ...
    Else
        ...
        Call WriteChatOverHead(UserIndex, "¡Falla!", UserList(UserIndex).Char.CharIndex, vbRed)
    End If
...
On Error GoTo Errhandler
    ...
    With UserList(AtacanteIndex)
        ...
        End Select
        If daño < 150 Then
            Call WriteChatOverHead(AtacanteIndex, daño, UserList(AtacanteIndex).Char.CharIndex, vbRed)
            Call WriteChatOverHead(VictimaIndex, daño, UserList(AtacanteIndex).Char.CharIndex, vbRed)
        Else
            Call WriteChatOverHead(AtacanteIndex, "¡" & daño & "!", UserList(AtacanteIndex).Char.CharIndex, vbYellow)
            Call WriteChatOverHead(VictimaIndex, "¡" & daño & "!", UserList(AtacanteIndex).Char.CharIndex, vbYellow)
        End If
...
'***************************************************
    ...
    If Duelos_UsuariosEnDuelo(VictimIndex, AttackerIndex) = False Then
...
On Error GoTo Errhandler
    ...
    If UserList(VictimIndex).flags.EnConsulta Then
        ...
        Exit Function
    End If
    'Check si estan en duelo
   
    If Duelos_UsuariosEnDuelo(VictimIndex, AttackerIndex) Then
