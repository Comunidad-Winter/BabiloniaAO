        ...
        If Slot > .CurrentInventorySlots Then
           ...
           Do Until .Invent.Object(Slot).ObjIndex = 0
               ...
               If Slot > .CurrentInventorySlots Then
                   ...
                   Call SendData(SendTarget.ToPCArea, UserIndex, PrepareMessagePlayWave(INVENTARIOLLENO, .Pos.X, .Pos.Y))
...
Call WriteConsoleMsg(UserIndex, "Pierdes la parálisis", FontTypeNames.FONTTYPE_INFO)
  'Quitamos del inv el item
                Call QuitarUserInvItem(UserIndex, Slot, 1)
Call UpdateUserInv(False, UserIndex, Slot) 'me habia olvidado de qe actualize el INV, ahora si al 100% funcional.
        Else
