...
Begin VB.Form frmCrearPersonaje 
   ...
   Begin VB.ComboBox lstAlienacion 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   315
      ItemData        =   "frmCrearPersonaje.frx":43E63
      Left            =   2640
      List            =   "frmCrearPersonaje.frx":43E6D
   ...
   Begin VB.ComboBox lstProfesion 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   315
      ItemData        =   "frmCrearPersonaje.frx":43E80
      Left            =   1680
      List            =   "frmCrearPersonaje.frx":43E82
      Style           =   2  'Dropdown List
      TabIndex        =   6
      Top             =   6600
      Width           =   2385
   ...
   Begin VB.ComboBox lstGenero 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   315
      ItemData        =   "frmCrearPersonaje.frx":43E84
      Left            =   1680
      List            =   "frmCrearPersonaje.frx":43E8E
      Style           =   2  'Dropdown List
      TabIndex        =   7
      Top             =   7200
      Width           =   2385
   ...
   Begin VB.ComboBox lstRaza 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   315
      ItemData        =   "frmCrearPersonaje.frx":43EA1
      Left            =   1680
      List            =   "frmCrearPersonaje.frx":43EA3
      Style           =   2  'Dropdown List
      TabIndex        =   5
      Top             =   6000
      Width           =   2415
   ...
   Begin VB.ComboBox lstHogar 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   315
      ItemData        =   "frmCrearPersonaje.frx":43EA5
      Left            =   1680
      List            =   "frmCrearPersonaje.frx":43EA7
      Style           =   2  'Dropdown List
      TabIndex        =   4
      Top             =   5400
      Width           =   2385
   ...
   Begin VB.Image DirPJ 
      ...
      Index           =   1
      Left            =   9120
      Picture         =   "frmCrearPersonaje.frx":43EA9
      Top             =   6120
      Visible         =   0   'False
      Width           =   240
   End
   Begin VB.Image DirPJ 
      ...
      Index           =   0
      Left            =   7440
      Picture         =   "frmCrearPersonaje.frx":441BB
      Top             =   6120
      Visible         =   0   'False
      Width           =   240
   End
   Begin VB.Image HeadPJ 
      ...
      Index           =   1
      Left            =   9000
      Picture         =   "frmCrearPersonaje.frx":444CD
      Top             =   7200
      Visible         =   0   'False
      Width           =   240
   End
   Begin VB.Image HeadPJ 
      ...
      Index           =   0
      Left            =   7440
      Picture         =   "frmCrearPersonaje.frx":447DF
      Top             =   7200
      Visible         =   0   'False
      Width           =   240
   End
   ...
   Begin VB.Image imgDados 
      Height          =   885
      Left            =   9600
      MouseIcon       =   "frmCrearPersonaje.frx":44AF1
   ...
   Begin VB.Image imgHogar 
      Height          =   2850
      Left            =   5640
      Picture         =   "frmCrearPersonaje.frx":44C43
      Top             =   9120
      Visible         =   0   'False
      Width           =   2985
   End
