...
Begin VB.Form frmMain 
   ...
   Begin VB.Image cmdMoverHechi 
      ...
      Index           =   0
      Left            =   11400
      MouseIcon       =   "frmMain.frx":15FF70
      MousePointer    =   99  'Custom
      Picture         =   "frmMain.frx":1600C2
      Top             =   4080
      Visible         =   0   'False
      Width           =   225
   End
   Begin VB.Image cmdMoverHechi 
      ...
      Index           =   1
      Left            =   11400
      MouseIcon       =   "frmMain.frx":160406
      MousePointer    =   99  'Custom
      Picture         =   "frmMain.frx":160558
      Top             =   3480
      Visible         =   0   'False
      Width           =   225
   End
...
Private Sub imgVerForo_Click()
 Call ShellExecute(0, "Open", "https://www.facebook.com/pages/Babiloniaao-Oficial/736827669766762?ref=hl", "", App.path, SW_SHOWNORMAL)
End Sub
...
ShowConsoleMsg "Cuando el Global este activo, presiona /GLOBAL (Texto) para dialogar..", 250, 250, 150, False
End Sub
...
If MINUTOSSPAM = 15 Then 'Si quieren pueden reemplazar 15 por los mintos que van a poner.
MINUTOSSPAM = 0
    Call ShowConsoleMsg("Servidor> Recuerden que la web es https://www.facebook.com/pages/Babiloniaao-Oficial/736827669766762?ref=aymt_homepage_panel . CUALQUIER DUDA O CONSULTA /GM ", 255, 255, 255, True, False) 'Reemplazar lo que está entre comillas con el mensaje que deseen enviar.
End If
MINUTOSSPAM = MINUTOSSPAM + 1
End Sub
